...
export function TextLink({
  ...
  if (linkText && onPress && !text && !links) {
    return (
      <View style={[styles.container, {justifyContent: getJustifyContent(align)}, containerStyle]}>
...
function getJustifyContent(align: 'left' | 'center' | 'right'): 'flex-start' | 'center' | 'flex-end' {
  switch (align) {
    case 'left':
      return 'flex-start';
    case 'center':
