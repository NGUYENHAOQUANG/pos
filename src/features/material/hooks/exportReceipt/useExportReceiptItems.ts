...
import { GetExportReceiptItemsResponseData } from '@/features/material/types/exportReceipt.types';
    ...
    return useQuery({
        ...
        queryFn: async () => {
            ...
            if (response.success && response.data) {
                const data = response.data as GetExportReceiptItemsResponseData;
