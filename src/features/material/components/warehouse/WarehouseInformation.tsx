...
export const WarehouseInformation: React.FC<WarehouseInformationProps> = ({
  ...
  return (
    <View style={styles.cardContainer}>
      <CollapseHead title="Thông tin nhập kho" isExpanded={isExpanded} onToggle={toggleExpand} />
        ...
        <View style={styles.content}>
          ...
          <View style={styles.inputGroup}>
            ...
            >
              ...
              <Ionicons name="calendar-outline" size={20} color={colors.textSecondary || '#999'} />
            </TouchableOpacity>
          </View>
