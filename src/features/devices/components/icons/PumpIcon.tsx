...
import XyphonSvg from '@/assets/images/xyphon.svg'; // Pump dùng chung SVG với Xyphon
...
export const PumpIcon = React.memo(function PumpIcon({
  width = 64,
  height = 64,
  color: _color = '#00BCD4',
  isActive = false,
  ...
  return (
    <Animated.View
      style={animatedStyle}
      accessible={true}
      accessibilityLabel={isActive ? 'Máy bơm đang hoạt động' : 'Máy bơm đã tắt'}
