      ...
      return (
        <View style={[styles.triggerContainer, styles.triggerOpen]}>
          ...
          <TouchableOpacity onPress={() => setIsOpen(false)}>
            <Ionicons name="search-outline" size={20} color={colors.gray[200]} />
          </TouchableOpacity>
        </View>
      );
    }
        ...
        <View style={styles.dropdown}>
          {filteredData.length > 0 ? (
            <FlatList
              ...
              renderItem={({ item }) => {
                const isOutOfStock = item.remaining === 0 || item.remaining === undefined;
                return (
                  <TouchableOpacity style={styles.item} onPress={() => handleSelect(item)}>
                    ...
                    <View style={styles.stockContainer}>
                      <Text style={[styles.itemStock, isOutOfStock && styles.textDisabled]}>
