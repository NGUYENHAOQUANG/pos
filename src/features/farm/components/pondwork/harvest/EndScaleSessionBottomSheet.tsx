...
export interface EndScaleSessionBottomSheetProps {
    visible: boolean;
    onClose: () => void;
    onConfirm: () => void | Promise<void>;
}

export const EndScaleSessionBottomSheet: React.FC<EndScaleSessionBottomSheetProps> = ({
    visible,
    onClose,
    onConfirm,
}) => {
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.body}>
                        <Text style={styles.bodyText}>
                            Bạn chắc chắn muốn kết thúc phiên cân này? Vui lòng kiểm tra kỹ trước
                            khi xác nhận
                        </Text>
                    </View>
                </View>
