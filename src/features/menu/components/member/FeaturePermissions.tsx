      ...
      <View style={[styles.content, disabled && styles.disabledContent]}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.radioGroup}>
            ...
            >
              <Ionicons
                name={managementLevel === 'farm' ? 'radio-button-on' : 'radio-button-off'}
                size={20}
                color={
                  disabled
            ...
            >
              <Ionicons
                name={managementLevel === 'pond' ? 'radio-button-on' : 'radio-button-off'}
                size={20}
                color={
                  disabled
                    ? colors.textSecondary
            ...
            {selectedUnits.map(unit => (
              <View key={unit.id} style={styles.selectedUnitItem}>
                ...
                {disabled && (
                  ...
                  >
                    <DeleteIcon width={16} height={16} color={colors.textSecondary} />
                  </View>
                )}
              </View>
            ))}
        ...
        <View style={styles.section}>
          <View style={styles.rowBetween}>
            ...
            >
              ...
              >
                {isAllSelected && <Ionicons name="checkmark" size={14} color={colors.white} />}
              </View>
              <Text style={[styles.checkboxText, disabled && { color: colors.textSecondary }]}>
                Chọn tất cả
              </Text>
            </TouchableOpacity>
          </View>
            ...
            {PERMISSIONS.map(permission => {
              ...
              return (
                ...
                >
                  ...
                  <Text
                    style={[styles.permissionText, disabled && { color: colors.textSecondary }]}
                  >
                    {permission.label}
                  </Text>
                </TouchableOpacity>
